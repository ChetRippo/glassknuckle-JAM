	...
	if (GetComponent(date).currentDate == animalName){
		if (playerObject.GetComponent(player).levelGiraffe == 0){
			...
			if (GetComponent(date).pos == 4) {
				...
				GetComponent(date).prompt = true;
				if (GUI.Button(Rect(promptX,prompt1Y,promptW,promptH),"What? I can't hear you...",promptStyle)){
					GetComponent(date).pos++;
					GetComponent(date).prompt = false;
				}
				if (GUI.Button(Rect(promptX,prompt2Y,promptW,promptH),"What? I can't hear you...",promptStyle)){
					GetComponent(date).pos++;
					GetComponent(date).prompt = false;
				}
				if (GUI.Button(Rect(promptX,prompt3Y,promptW,promptH),"What? I can't hear you...",promptStyle)){
					GetComponent(date).pos++;
					GetComponent(date).prompt = false;
				}
			}
			...
			if (GetComponent(date).pos == 16) {
				GetComponent(date).vocal = "Is it….NAME?";
				GetComponent(date).action = false;
			}
			...
			if (GetComponent(date).pos == 19) {
				GetComponent(date).vocal = "Oh! It's NAME! Great!";
				GetComponent(date).action = false;
			}
			...
			if (GetComponent(date).pos == 24) {
				GetComponent(date).vocal = "Are you in to tall partners?";
				GetComponent(date).action = true;
				GetComponent(date).prompt = true;
			...
			if (GetComponent(date).pos == 1) {
				GetComponent(date).vocal = "Is that you, NAME?";
				GetComponent(date).action = false;
			}
			if (GetComponent(date).pos == 2) {
			...
			if (GetComponent(date).pos == 17) {
				GetComponent(date).vocal = "But you get me, NAME. You're a real down-to-earth kind of person.";
			}
			if (GetComponent(date).pos == 18) {
			...
			if (GetComponent(date).pos == 22) {
				GetComponent(date).vocal = "You strap some climbing gear and start moving up Giraffe's firm neck.";
				GetComponent(date).action = true;
			}
			if (GetComponent(date).pos == 23) {
